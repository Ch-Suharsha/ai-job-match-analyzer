...
.lb-company { font-family: 'DM Mono', monospace; font-size: 0.65rem; color: #6B5A3E; letter-spacing: 0.08em; margin-top: 0.25rem; }
.lb-location { font-family: 'DM Mono', monospace; font-size: 0.62rem; color: #4A3D28; letter-spacing: 0.05em; padding-top: 0.15rem; }
.lb-score-wrap { display: flex; flex-direction: column; gap: 0.3rem; }
.lb-score-num { font-family: 'Playfair Display', serif; font-size: 1.1rem; color: #C9A84C; font-weight: 400; }
.lb-score-bar-bg { height: 2px; background: #1E1810; border-radius: 1px; overflow: hidden; width: 100%; }
.lb-score-bar { height: 2px; background: linear-gradient(to right, #8B5E3C, #C9A84C); border-radius: 1px; }
.lb-tier {
    font-family: 'DM Mono', monospace;
    font-size: 0.52rem;
...
.summary-card { background: #0A0804; padding: 2rem; }
...
with st.sidebar:
    ...
    <div style="padding:1.5rem 0 1rem 0;border-bottom:1px solid #1E1810;margin-bottom:1rem;">
        ...
        <div style="font-family:'DM Mono',monospace;font-size:0.52rem;letter-spacing:0.22em;
                    color:#3D3020;text-transform:uppercase;margin-top:0.3rem;">Intelligence Platform</div>
    </div>
    ...
    tier_filter = st.multiselect(
        "Match Tier", label_visibility="collapsed",
...
with col1:
    ...
    fig.add_annotation(
        ...
        text=f"avg {metrics['avg_match_score']}%",
        showarrow=False, xanchor="left", xshift=6,
        font=dict(family="DM Mono, monospace", size=9, color="#6B5A3E"),
    )
...
<div style="font-family:'Playfair Display',serif;font-size:1.6rem;font-weight:400;
            color:#D4C4A0;font-style:italic;margin-bottom:0.4rem;">Ranked by Semantic Match</div>
...
<div class="leaderboard-row leaderboard-header" style="background:transparent;">
    <div style="font-family:'DM Mono',monospace;font-size:0.5rem;letter-spacing:0.2em;color:#3D3020;text-transform:uppercase;">#</div>
    <div style="font-family:'DM Mono',monospace;font-size:0.5rem;letter-spacing:0.2em;color:#3D3020;text-transform:uppercase;">Position</div>
    <div style="font-family:'DM Mono',monospace;font-size:0.5rem;letter-spacing:0.2em;color:#3D3020;text-transform:uppercase;">Location</div>
    <div style="font-family:'DM Mono',monospace;font-size:0.5rem;letter-spacing:0.2em;color:#3D3020;text-transform:uppercase;">Match</div>
    <div style="font-family:'DM Mono',monospace;font-size:0.5rem;letter-spacing:0.2em;color:#3D3020;text-transform:uppercase;">Tier</div>
    <div style="font-family:'DM Mono',monospace;font-size:0.5rem;letter-spacing:0.2em;color:#3D3020;text-transform:uppercase;">Apply</div>
</div>
""", unsafe_allow_html=True)
...
for i, row in df.head(20).iterrows():
    ...
    <div class="leaderboard-row {delay}">
        ...
        <div>
            ...
            <div class="lb-company">{str(row['company']).upper()}</div>
        </div>
        <div class="lb-location">{remote_label}</div>
        <div class="lb-score-wrap">
            <div class="lb-score-num">{row['match_score']:.0f}%</div>
            <div class="lb-score-bar-bg"><div class="lb-score-bar" style="width:{bar}%"></div></div>
        </div>
...
<div style="margin-top:5rem;padding-top:2rem;border-top:1px solid #1A1510;
    ...
    <div style="font-family:'Playfair Display',serif;font-size:1rem;color:#2A2018;letter-spacing:0.2em;">ORBIS</div>
    <div style="font-family:'DM Mono',monospace;font-size:0.5rem;letter-spacing:0.2em;
                color:#2A2018;text-transform:uppercase;">
